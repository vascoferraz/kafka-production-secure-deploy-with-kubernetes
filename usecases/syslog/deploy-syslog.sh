...
kubectl cp $TUTORIAL_HOME/certificates/generated/postgres.pem confluent/connect-0:/tmp/ -c connect
kubectl cp $TUTORIAL_HOME/certificates/generated/postgres-key.pem confluent/connect-0:/tmp/ -c connect
kubectl cp $TUTORIAL_HOME/certificates/generated/ca.pem confluent/connect-0:/tmp/ -c connect
