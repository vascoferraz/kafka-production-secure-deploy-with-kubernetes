...
=======
docker build -t leenooks/phpldapadmin-vf:2.0.0-dev --progress=plain --platform linux/arm64 -f $TUTORIAL_HOME/docker-images/phpldapadmin/Dockerfile ../
>>>>>>> fc5a746 (Build phpLDAPadmin image for arm64 architecture)
